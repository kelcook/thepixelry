...
<head>
	...
	<title>Sign Up | Code Camps for Girls in Greenville, SC</title>
...
<body>
	...
	<main class="main">
	    <section class="section section--signup">
    		<div class="wrap">
		    	<h2 class="section__header section__header--single">Sign Up</h2>
		    	<div class="row flex flex-row">
		    		<div>
		    			<p class="p--center">We're sorry, there seems to be an error with the sign up form. Please contact Katie at (419) 651-2751.</p>
		    		</div>
				</div>
		    </div>
	    </section>
